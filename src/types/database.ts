...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      decay_trust_scores: { Args: never; Returns: undefined }
      demote_inactive_contributors: { Args: never; Returns: undefined }
      ...
      run_masjidy_weekly_maintenance: { Args: never; Returns: undefined }
      st_3dclosestpoint: {
        Args: { geom1: unknown; geom2: unknown }
        Returns: unknown
      }
