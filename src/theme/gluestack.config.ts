/**
 * Gluestack UI v3 numbered color scales as plain CSS variable maps (RGB triplets).
 * Wrapped with `vars()` in ThemeProvider (native) and gluestack-ui-provider/config.ts (web).
 */

export const gluestackNumberedScaleLight: Record<string, string> = {
...
export const gluestackNumberedScaleDark: Record<string, string> = {
